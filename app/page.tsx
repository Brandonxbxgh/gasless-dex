  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 pt-8 sm:p-6 sm:pt-10">
      <div className="text-center mb-6 sm:mb-8">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight bg-gradient-to-r from-cyan-300 via-violet-300 to-cyan-400 bg-clip-text text-transparent mb-3">
          DeltaChainLabs
        </h1>
      ...
      <Swap />
      <p className="mt-6 text-sm text-slate-400 text-center max-w-sm bg-slate-800/50 rounded-lg px-4 py-2 border border-cyan-500/20">
